...
export interface Trading {
  ...
  buy: (params: BuyParams, router: Address) => Promise<Hex>
  sell: (params: SellParams, router: Address) => Promise<Hex>
  sellPermit: (params: SellPermitParams, router: Address) => Promise<Hex>
...
export function createTrading(config: TradingConfig): Trading {
